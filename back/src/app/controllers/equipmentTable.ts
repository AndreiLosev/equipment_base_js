...
export class EquipmentTable {
    ...
    static create_table = (conn: DB) =>
        (req: Request<any, any, any, TatableName>, res: Response<{}>) => {
    ...
    static get = (conn: DB) =>
        (req: Request<any, any, any, TatableName>, res: Response<TEquipment[]>) => {
            EquipmentTable.sender(res, conn.get(req.query.table_name))
        }

    static set = (conn: DB) =>
        (req: Request<any, any, TEquipment, TatableName>, res: Response<{}>) => {
    ...
    static del = (conn: DB) =>
        (req: Request<any, any, {id: number}, TatableName>, res: Response<{}>) => {
            EquipmentTable.sender(res, conn.delete(req.query.table_name, req.body.id))
        }

    static get_by_num = (conn: DB) =>
        (req: Request<any, any, any, Search_by_num>, res: Response<TEquipment[]>) => {
    ...
    static get_by_str = (conn: DB) =>
        (req: Request<any, any, any, Search_by_str>, res: Response<TEquipment[]>) => {
